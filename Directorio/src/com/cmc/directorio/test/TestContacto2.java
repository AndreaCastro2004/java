...
public class TestContacto2 {
	...
	public static void main(String[] args) {
		...
		Telefono telf1=new Telefono ("claro","0987654321",15);
		Contacto c=new Contacto("Mario", "Bros", telf1, 190);
		Telefono telf2=new Telefono ("claro","0123456678",90);
		Contacto c2=new Contacto("Juan", "Escariote", telf2, 60);
